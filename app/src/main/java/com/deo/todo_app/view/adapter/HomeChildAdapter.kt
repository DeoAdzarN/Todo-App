...
class HomeChildAdapter (private val fragmentManager:FragmentManager, private val tasks: List<Task>) : RecyclerView.Adapter<HomeChildAdapter.ViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return if (tasks.size > 3) 3 else tasks.size
    }
